    ...
    $.fn.wa_image_comparison = function(options) {
      ...
      return this.each(function() {
        ...
        if(!options.no_overlay) {
          container.append(`<div class='wa_image_comparison-overlay ${options.show_labels_on_hover ? 'wa_image_comparison_label_show_on_hover' : '' }'></div>`);
          var overlay = container.find(".wa_image_comparison-overlay");
          overlay.append(`<div class='wa_image_comparison-before-label' data-content='${options.before_label}'></div>`);
          overlay.append(`<div class='wa_image_comparison-after-label' data-content='${options.after_label}'></div>`);
        }
