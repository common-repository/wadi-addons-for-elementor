...
!function() {
/*!*******************************!*\
  !*** ./src/media-carousel.js ***!
  \*******************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var swiper__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! swiper */ "../node_modules/swiper/swiper.esm.js");
/* harmony import */ var _style_media_carousel_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./style/media-carousel.scss */ "./src/style/media-carousel.scss");
...
var WadiMediaCarousel = /*#__PURE__*/function (_elementorModules$fro) {
  _inherits(WadiMediaCarousel, _elementorModules$fro);

  var _super = _createSuper(WadiMediaCarousel);

  function WadiMediaCarousel() {
    _classCallCheck(this, WadiMediaCarousel);

    return _super.apply(this, arguments);
  }

  _createClass(WadiMediaCarousel, [{
    ...
    value: function initiate() {
      ...
      var $wadiMediaSwiperElem = this.elements.wadiMediaSwiperElem;
      var elementsSettings = this.getElementSettings();
      var currentDeviceMode = elementorFrontend.getCurrentDeviceMode();
      var selectors = this.getSettings('selectors');

      var wadiMediaCarouselSwiperSettings = _objectSpread(_objectSpread(_objectSpread(_objectSpread(_objectSpread(_objectSpread({
        ...
        carouselCubeEffect: _objectSpread({
    ...
    key: "wadiMediaSwiper",
    value: function wadiMediaSwiper(wadiMediaSwiperElem, settings) {
      var _breakpoints;

      var carouselMediaBreakpointMobile = settings.carouselMediaBreakPoints.mobile;
      var carouselMediaBreakpointTablet = settings.carouselMediaBreakPoints.tablet;
      var carouselMediaBreakpointDesktop = settings.carouselMediaBreakPoints.desktop;
      var $this = this; // Swiper Thumbs

      var wadiMediaSwiperThumbsElement = settings.wadiMediaSwiperThumbsElement;
      var swiperThumbs; // Check if Carousel Thumbs (Slideshow) is enabled

      if ('slideshow' === settings.carouselMediaCarouselSkin) {
        var _Swiper;

        // if yes create new Swiper instance        
        swiperThumbs = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](wadiMediaSwiperThumbsElement, (_Swiper = {
          modules: [swiper__WEBPACK_IMPORTED_MODULE_0__.EffectFade, swiper__WEBPACK_IMPORTED_MODULE_0__.EffectCube, swiper__WEBPACK_IMPORTED_MODULE_0__.EffectFlip, swiper__WEBPACK_IMPORTED_MODULE_0__.EffectCoverflow, swiper__WEBPACK_IMPORTED_MODULE_0__.EffectCards, swiper__WEBPACK_IMPORTED_MODULE_0__.FreeMode, swiper__WEBPACK_IMPORTED_MODULE_0__.Autoplay, swiper__WEBPACK_IMPORTED_MODULE_0__.Controller, swiper__WEBPACK_IMPORTED_MODULE_0__.Mousewheel, swiper__WEBPACK_IMPORTED_MODULE_0__.Navigation, swiper__WEBPACK_IMPORTED_MODULE_0__.Pagination, swiper__WEBPACK_IMPORTED_MODULE_0__.Scrollbar, swiper__WEBPACK_IMPORTED_MODULE_0__.Thumbs, swiper__WEBPACK_IMPORTED_MODULE_0__.Lazy],
          spaceBetween: 10,
          initialSlide: settings.carouselMediaInitialSlide,
          slidesPerView: settings.carouselThumbsSlidesPerView
        }, _defineProperty(_Swiper, "spaceBetween", settings.carouselThumbSpacebetween.size), _defineProperty(_Swiper, "loop", true), _defineProperty(_Swiper, "slideToClickedSlide", true), _defineProperty(_Swiper, "freeMode", true), _defineProperty(_Swiper, "watchSlidesProgress", true), _defineProperty(_Swiper, "lazy", {
          loadPrevNext: true
        }), _Swiper));
      }

      var wadiMediaSwiperElement = settings.wadiMediaSwiperElement;
      var swiper = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](wadiMediaSwiperElement, _objectSpread(_objectSpread(_objectSpread(_objectSpread(_objectSpread(_objectSpread(_objectSpread(_objectSpread(_objectSpread(_objectSpread({
        modules: [swiper__WEBPACK_IMPORTED_MODULE_0__.EffectFade, swiper__WEBPACK_IMPORTED_MODULE_0__.EffectCube, swiper__WEBPACK_IMPORTED_MODULE_0__.EffectFlip, swiper__WEBPACK_IMPORTED_MODULE_0__.EffectCoverflow, swiper__WEBPACK_IMPORTED_MODULE_0__.EffectCards, swiper__WEBPACK_IMPORTED_MODULE_0__.FreeMode, swiper__WEBPACK_IMPORTED_MODULE_0__.Autoplay, swiper__WEBPACK_IMPORTED_MODULE_0__.Controller, swiper__WEBPACK_IMPORTED_MODULE_0__.Mousewheel, swiper__WEBPACK_IMPORTED_MODULE_0__.Navigation, swiper__WEBPACK_IMPORTED_MODULE_0__.Pagination, swiper__WEBPACK_IMPORTED_MODULE_0__.Scrollbar, swiper__WEBPACK_IMPORTED_MODULE_0__.Thumbs, swiper__WEBPACK_IMPORTED_MODULE_0__.Lazy],
        initialSlide: settings.carouselMediaInitialSlide,
        ...
        }, settings.carouselMediaDirection === 'vertical' && settings.carouselMediaPaginationType === 'progressbar' && {
          progressbarOpposite: settings.carouselMediaProgressbarOpposite
        })
      ...
      }, settings.carouselSlideEffect === 'fade' && {
        fadeEffect: {
          crossFade: true
        }
      }), settings.carouselSlideEffect === 'coverflow' && {
        coverflowEffect: settings.carouselCoverflowEffect
      }), settings.carouselSlideEffect === 'flip' && {
        flipEffect: settings.carouselFlipEffect
      }), settings.carouselSlideEffect === 'cube' && {
        cubeEffect: settings.carouselCubeEffect
      }), settings.carouselSlideEffect === 'cards' && {
        cardsEffect: settings.carouselCardsEffect
...
jQuery(window).on("elementor/frontend/init", function () {
  ...
  elementorFrontend.hooks.addAction("frontend/element_ready/wadi-media-carousel-addon.default", addHandler);
});
}();
/******/ })()
;
//# sourceMappingURL=wadi-media-carousel.js.map