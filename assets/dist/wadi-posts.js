...
/* harmony import */ var _node_modules_swiper__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../node_modules/swiper */ "../node_modules/swiper/swiper.esm.js");
/* harmony import */ var _style_posts_scss__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./style/posts.scss */ "./src/style/posts.scss");
...
var WadiPosts = /*#__PURE__*/function (_elementorModules$fro) {
  _inherits(WadiPosts, _elementorModules$fro);

  var _super = _createSuper(WadiPosts);

  function WadiPosts() {
    _classCallCheck(this, WadiPosts);

    return _super.apply(this, arguments);
  }

  _createClass(WadiPosts, [{
    ...
    value: function initiate() {
      var _this = this; // const $wadiGalleryGridElementorContainer = this.elements.$wadiGalleryGridElementorContainer;
    ...
    key: "wadiPosts",
    value: function wadiPosts(settings, $) {
      var _this2 = this;

      var selectors = this.getSettings('selectors');
      var theSettings = this.getSettings('settings');
      var WadiSettings = this.getElementSettings();
      var postsColumnsWidthString = settings.postsColumnsWidth;
      var postsColumnsWidth = postsColumnsWidthString.replace('%', "");
      var postsColumnsWidthNum = parseFloat(postsColumnsWidth);
      var pagination = settings.postsPaginate;
      var infinite = settings.postsInfinite;
      var carousel = settings.postsCarouselLayout;
      var postsFilterContainer = this.$element.find(selectors.wadiPostsFilterContainer);
      var wadiActiveCategoryClass = selectors.wadiActiveCategory;
      var wadiPostsActiveCategory = postsFilterContainer.find('.data_filter.filter_active');

      var _this = this;

      var wadiPostsContainer = document.querySelector(settings.wadiPostsContainerElem);
      var wadiPostsWrapper = document.querySelector(settings.wadiPostsWrapper);
      var wadiPostsWrapperArray = document.querySelectorAll('.wadi_posts_content_wrapper');
      wadiPostsWrapperArray.forEach(function (postsElem, index) {
        if (postsElem.querySelector('.wadi_posts_container_' + _this2.$element[0].getAttribute("data-id"))) {
          var layoutSettings = {};
          ...
          if (settings.postsLayout === 'masonry' || settings.postsLayout === 'fitRows') {
            var iso = new (isotope_layout__WEBPACK_IMPORTED_MODULE_0___default())(postsElem.querySelector('.wadi_posts_container_' + _this2.$element[0].getAttribute("data-id")), {
              // options
            ...
            new (imagesloaded__WEBPACK_IMPORTED_MODULE_1___default())(postsElem.querySelector('.wadi_posts_container_' + _this2.$element[0].getAttribute("data-id")), iso); // this.getWadiPostsFilter(postsElem); // One is enough in the next lines!.
          }

          if (settings.postsLayout === 'grid' || settings.postsLayout === 'masonry' || settings.postsLayout === 'fitRows') {
            _this2.getWadiPostsFilter(postsElem, settings);
          }
        }
      });
    ...
    key: "getWadiPostsFilter",
    value: function getWadiPostsFilter(postsElem, settings) {
      var _this3 = this;
      ...
      var theSettings = this.getSettings('settings');
      var selectors = this.getSettings('selectors');
      var filtersPostsWadiElem = postsElem.querySelector('.wadi_tax_filters'); // const settings = this.getElementSettings();

      var pageNumber = theSettings.pageNumber; // console.log(postsElem);

      var $postsContainer = this.elements.$wadiPostsElementorContainer; // const $wadiPostsElementorWrapper = this.elements.$wadiPostsElementorWrapper;

      var $paginationContainer = _this.$element.find('.wadi_posts_pagination_container');

      var activeCategory = this.$element[0].querySelector(selectors.wadiActiveCategory);
      var theActiveCategory;
      ...
      if (filtersPostsWadiElem) {
        var itemsList = filtersPostsWadiElem.querySelectorAll("[data-filter]");
        var itemsListArray = Array.from(itemsList);
        filtersPostsWadiElem.addEventListener('click', function (event) {
          return filterPostsItems(event);
        });

        var filterPostsItems = function filterPostsItems(event) {
          var _getWidgetAttributes$, _getWidgetAttributes$2;

          if (!event.target.hasAttribute("data-filter")) {
            return;
          }

          var $scope = jQuery(event.target).closest('.elementor-widget-wadi-posts-addon');
          var $postsContainer = $scope.find('.wadi_posts_container');
          var $paginationContainer = $scope.find('.wadi_posts_pagination_container');
          var getWidgetAttributes = $scope.find('.wadi_posts_content_wrapper');
          var args = {
            page_id: (_getWidgetAttributes$ = getWidgetAttributes[0]) === null || _getWidgetAttributes$ === void 0 ? void 0 : _getWidgetAttributes$.getAttribute('data-page'),
            widget_id: (_getWidgetAttributes$2 = getWidgetAttributes[0]) === null || _getWidgetAttributes$2 === void 0 ? void 0 : _getWidgetAttributes$2.getAttribute("data-id"),
            page_number: theSettings === null || theSettings === void 0 ? void 0 : theSettings.pageNumber,
            category: theActiveCategory ? theActiveCategory : ''
          };
          var filterValue = event.target.getAttribute('data-filter');
          itemsListArray.forEach(function (it) {
            return it.classList.remove('filter_active');
          });
          var item = filtersPostsWadiElem.querySelector("[data-filter=\"".concat(filterValue, "\"]"));
          item.classList.add('filter_active');
          localStorage.setItem('wadiPostActiveFilter', filterValue); // Make Sure Page Number is Set to first one when click on Category Tab
          // pageNumber = 1;

          args.category = filterValue;
          args.page_number = 1;
          pageNumber = args.page_number;
          theSettings.pageNumber = 1; // Check if infinite is active

          if (settings !== null && settings !== void 0 && settings.postsInfinite) {
            theSettings.count = 2; // theSettings.pageNumber = theSettings.count;

            theSettings.filterTabsExist = true;

            _this3.getWadiPostsAjax(args, $postsContainer, $paginationContainer);
          } else {
            _this3.getWadiPostsAjax(args, $postsContainer, $paginationContainer);
    ...
    key: "getWadiPostsAjax",
    value: function getWadiPostsAjax(args, $postsContainer, $paginationContainer) {
      var _this = this;

      var settings = this.getElementSettings();
      var selectors = this.getSettings('selectors');
      var theSettings = this.getSettings('settings');
      var infinitePosts = settings.wadi_posts_pagination_select === "infinite" ? true : false;
      var paginationPosts = settings.wadi_posts_pagination_select === "numbers" ? true : false;
      var infiniteButtonLoadMore = settings.wadi_posts_pagination_infinite_select === 'wadi_infinite_button' ? true : false;
      var infiniteScroll = settings.wadi_posts_pagination_infinite_select === 'wadi_infinite_scroll' ? true : false;
      var activeCategory = this.$element[0].querySelector(selectors.wadiActiveCategory);
      var theActiveCategory;
      ...
      jQuery.ajax({
        ...
        success: function success(response) {
          var _response$data, _response$data2, _this$$element$;

          // const currentPage = $paginationContainer.attr('data-current');
          var posts = response === null || response === void 0 ? void 0 : (_response$data = response.data) === null || _response$data === void 0 ? void 0 : _response$data.posts,
              paging = response === null || response === void 0 ? void 0 : (_response$data2 = response.data) === null || _response$data2 === void 0 ? void 0 : _response$data2.paging;
          ...
          var total = _this.$element.find('.wadi_posts_pagination_container').data('max-pages');

          var current = _this.$element.find('.wadi_posts_pagination_container').data('current');

          var infiniteLoadMoreElem = _this.$element.find(".wadi_posts_pagination_container_".concat(_this === null || _this === void 0 ? void 0 : (_this$$element$ = _this.$element[0]) === null || _this$$element$ === void 0 ? void 0 : _this$$element$.getAttribute("data-id"), " .wadi_loadmore_infinite"));
    ...
    key: "wadiPaginatiePosts",
    value: function wadiPaginatiePosts() {
      var _this$$element$2;
      ...
      var theSettings = this.getSettings('settings');
      var settings = this.getElementSettings();
      jQuery(document).on('click', ".wadi_posts_pagination_container_".concat(this === null || this === void 0 ? void 0 : (_this$$element$2 = this.$element[0]) === null || _this$$element$2 === void 0 ? void 0 : _this$$element$2.getAttribute("data-id"), " .page-numbers"), function (e) {
        var _getWidgetAttributes$3, _getWidgetAttributes$4;

        var $scope = jQuery(e.target).closest('.elementor-widget-wadi-posts-addon');
        var getWidgetAttributes = $scope.find('.wadi_posts_content_wrapper');
        var $postsContainer = $scope.find('.wadi_posts_container_' + ((_getWidgetAttributes$3 = getWidgetAttributes[0]) === null || _getWidgetAttributes$3 === void 0 ? void 0 : _getWidgetAttributes$3.getAttribute("data-id")));
        var $paginationContainer = $scope.find('.wadi_posts_pagination_container_' + ((_getWidgetAttributes$4 = getWidgetAttributes[0]) === null || _getWidgetAttributes$4 === void 0 ? void 0 : _getWidgetAttributes$4.getAttribute("data-id")));
        var args = {
        ...
        var activeCategory = $scope[0].querySelector(selectors.wadiActiveCategory);
        var theActiveCategory;
    ...
    key: "wadiInfinitePosts",
    value: function wadiInfinitePosts() {
      var _this$$element$3;
      ...
      var theSettings = this.getSettings('settings');
      var pageNumber = theSettings.pageNumber;
      var settings = this.getElementSettings();
      var loadMore = false;
      var loadMoreScroll = (settings === null || settings === void 0 ? void 0 : settings.wadi_posts_pagination_infinite_select) === 'wadi_infinite_scroll' ? true : false;
      jQuery(document).on('click', ".wadi_posts_pagination_container_".concat(this === null || this === void 0 ? void 0 : (_this$$element$3 = this.$element[0]) === null || _this$$element$3 === void 0 ? void 0 : _this$$element$3.getAttribute("data-id"), " .wadi_loadmore_infinite"), function (e) {
        var _this$$element$4;

        var $scope = jQuery(e.target).closest('.elementor-widget-wadi-posts-addon');
        var getWidgetAttributes = $scope.find('.wadi_posts_content_wrapper');
        var $postsContainer = $scope.find('.wadi_posts_container_' + getWidgetAttributes[0].getAttribute("data-id"));
        var $paginationContainer = $scope.find('.wadi_posts_pagination_container_' + getWidgetAttributes[0].getAttribute("data-id"));
        var args = {
          page_id: getWidgetAttributes[0].getAttribute('data-page'),
          widget_id: getWidgetAttributes[0].getAttribute("data-id")
        };
        ...
        theSettings.loadingStatus = true; // Hide Load More if posts in the begining is less than the total if current page === total pages (One Page only)

        var total = $scope.find('.wadi_posts_pagination_container').data('max-pages');
        var current = $scope.find('.wadi_posts_pagination_container').data('current');
        var infiniteLoadMoreElem = $scope.find(".wadi_posts_pagination_container_".concat(_this === null || _this === void 0 ? void 0 : (_this$$element$4 = _this.$element[0]) === null || _this$$element$4 === void 0 ? void 0 : _this$$element$4.getAttribute("data-id"), " .wadi_loadmore_infinite"));
        ...
        if (theSettings.loadingStatus) {
          ...
          if (pageNumber < total) {
            jQuery(this).hide();
            args.category = theActiveCategory;
            args.page_number = theSettings.count, _this.getWadiPostsAjax(args, $postsContainer, $paginationContainer);
            theSettings.count++;
      ...
      jQuery(theWindow).on('scroll', function (e) {
        if (loadMoreScroll) {
          var _this$$element$find, _this$$element$find$o;

          if (jQuery(window).scrollTop() + windowHeight >= ((_this$$element$find = _this.$element.find('.wadi_single_post_container:last')) === null || _this$$element$find === void 0 ? void 0 : (_this$$element$find$o = _this$$element$find.offset()) === null || _this$$element$find$o === void 0 ? void 0 : _this$$element$find$o.top)) {
            var _this$$element$5;

            theSettings.loadingStatus = false;
            var activeCategory = _this === null || _this === void 0 ? void 0 : _this.$element[0].querySelector(selectors.wadiActiveCategory);
            var theActiveCategory;
            ...
            var getWidgetAttributes = _this === null || _this === void 0 ? void 0 : _this.$element.find('.wadi_posts_content_wrapper');
            var wadiSpinner = _this === null || _this === void 0 ? void 0 : _this.$element.find('.wadi_infinite_loader');
            var $postsContainer = _this === null || _this === void 0 ? void 0 : _this.$element.find('.wadi_posts_container_' + getWidgetAttributes[0].getAttribute("data-id"));
            var $paginationContainer = _this === null || _this === void 0 ? void 0 : _this.$element.find('.wadi_infinite_scroll_posts_' + getWidgetAttributes[0].getAttribute("data-id"));
            var loader = _this === null || _this === void 0 ? void 0 : _this.$element.find('.wadi_infinite_loader');
            var wadiPostsLoaderElement = "<div class='wadi_infinite_loader'>Loading...</div>";
            var args = {
              page_id: getWidgetAttributes[0].getAttribute('data-page'),
              widget_id: getWidgetAttributes[0].getAttribute("data-id")
            }; // Hide Load More if posts in the begining is less than the total if current page === total pages (One Page only)

            var total = _this === null || _this === void 0 ? void 0 : _this.$element.find('.wadi_posts_pagination_container').data('max-pages');
            var current = _this === null || _this === void 0 ? void 0 : _this.$element.find('.wadi_posts_pagination_container').data('current');
            var infiniteLoadMoreElem = _this === null || _this === void 0 ? void 0 : _this.$element.find(".wadi_infinite_scroll_posts_".concat(_this === null || _this === void 0 ? void 0 : (_this$$element$5 = _this.$element[0]) === null || _this$$element$5 === void 0 ? void 0 : _this$$element$5.getAttribute("data-id")));
            ...
            if (!loading && scrollHandling.allow) {
              ...
              if (theSettings.count <= total) {
                args.category = theActiveCategory;
                args.page_number = theSettings.count, theSettings.loadingStatus = true;
    ...
    key: "WadiCarouselPosts",
    value: function WadiCarouselPosts(settings) {
      var _breakpoints;

      console.log("Posts Swiper Carousel Logic");
      var wadiPostsSwiperElement = settings.wadiPostsSwiperElement;
      var postsCarouselBreakpointMobile = settings.postsCarouselBreakPoints.mobile;
      var postsCarouselBreakpointTablet = settings.postsCarouselBreakPoints.tablet;
      var postsCarouselBreakpointDesktop = settings.postsCarouselBreakPoints.desktop;
      console.log("Posts Settings", settings);
      console.log("wadiPostsSwiperElement", wadiPostsSwiperElement);
      new _node_modules_swiper__WEBPACK_IMPORTED_MODULE_2__["default"](wadiPostsSwiperElement, _objectSpread(_objectSpread({
        modules: [_node_modules_swiper__WEBPACK_IMPORTED_MODULE_2__.EffectFade, _node_modules_swiper__WEBPACK_IMPORTED_MODULE_2__.EffectCube, _node_modules_swiper__WEBPACK_IMPORTED_MODULE_2__.EffectFlip, _node_modules_swiper__WEBPACK_IMPORTED_MODULE_2__.EffectCoverflow, _node_modules_swiper__WEBPACK_IMPORTED_MODULE_2__.EffectCards, _node_modules_swiper__WEBPACK_IMPORTED_MODULE_2__.FreeMode, _node_modules_swiper__WEBPACK_IMPORTED_MODULE_2__.Autoplay, _node_modules_swiper__WEBPACK_IMPORTED_MODULE_2__.Controller, _node_modules_swiper__WEBPACK_IMPORTED_MODULE_2__.Mousewheel, _node_modules_swiper__WEBPACK_IMPORTED_MODULE_2__.Navigation, _node_modules_swiper__WEBPACK_IMPORTED_MODULE_2__.Pagination, _node_modules_swiper__WEBPACK_IMPORTED_MODULE_2__.Scrollbar],
        direction: 'horizontal',
        ...
        breakpoints: (_breakpoints = {}, _defineProperty(_breakpoints, postsCarouselBreakpointMobile, {
          slidesPerView: settings.postsSlidesPerViewMobile,
          spaceBetween: settings.carouselSpaceBetweenMobile
        }), _defineProperty(_breakpoints, postsCarouselBreakpointTablet, {
          slidesPerView: settings.postsSlidesPerViewTablet,
          spaceBetween: settings.carouselSpaceBetweenTablet
        }), _defineProperty(_breakpoints, postsCarouselBreakpointDesktop, {
          slidesPerView: settings.postsSlidesPerView,
...
jQuery(window).on("elementor/frontend/init", function () {
  ...
  elementorFrontend.hooks.addAction("frontend/element_ready/wadi-posts-addon.default", addHandler);
});
}();
/******/ })()
;
//# sourceMappingURL=wadi-posts.js.map