...
/* harmony import */ var _style_charts_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./style/charts.scss */ "./src/style/charts.scss");
...
var WadiCharts = /*#__PURE__*/function (_elementorModules$fro) {
  _inherits(WadiCharts, _elementorModules$fro);

  var _super = _createSuper(WadiCharts);

  function WadiCharts() {
    _classCallCheck(this, WadiCharts);

    return _super.apply(this, arguments);
  }

  _createClass(WadiCharts, [{
    ...
    value: function initiate() {
      ...
      var $wadiChart = this.elements.wadiChart;
      var elementsSettings = this.getElementSettings();
      var currentDeviceMode = elementorFrontend.getCurrentDeviceMode();
      var selectors = this.getSettings('selectors');

      var chartsSettings = _objectSpread(_objectSpread(_objectSpread(_objectSpread(_objectSpread(_objectSpread(_objectSpread(_objectSpread(_objectSpread(_objectSpread(_objectSpread(_objectSpread(_objectSpread({
      ...
      }, elementsSettings.wadi_show_x_switch === 'yes' && _objectSpread(_objectSpread({
      ...
      }, elementsSettings.wadi_show_y_switch === 'yes' && _objectSpread(_objectSpread({
      ...
      }, elementsSettings.wadi_chart_advanced_legend_display === 'yes' && _objectSpread(_objectSpread(_objectSpread(_objectSpread({
      ...
      }), elementsSettings.wadi_chart_content_type === 'csv' && _objectSpread(_objectSpread(_objectSpread({
    ...
    key: "wadiCharts",
    value: function wadiCharts(settings) {
      var _this2 = this,
          _settings$wadiAnimati,
          _settings$wadiAnimati2,
          _settings$wadiPointRa,
          _settings$wadiPointHo,
          _settings$wadiPointBo,
          _settings$wadiPointHo2,
          _settings$wadiPointHi,
          _settings$wadiChartLa,
          _settings$wadiChartLe,
          _settings$wadiChartLe2,
          _settings$wadiChartLe3,
          _settings$wadiChartLe4,
          _settings$wadiChartLe5,
          _settings$wadiChartTi,
          _settings$wadiChartTi2,
          _settings$wadiChartTo,
          _settings$wadiChartTo2,
          _settings$wadiChartTo3,
          _settings$wadiChartTo4,
          _settings$wadiChartTo5,
          _settings$wadiChartTo6,
          _settings$wadiChartTo7,
          _settings$wadiChartTo8,
          _settings$wadiChartTo9;

      var selectors = this.getSettings('selectors');
      var chartSettings = this.getElementSettings(); // console.log("wadiCharts Settings:",settings);

      var chartXLabels = settings.wadiChartXLabels;
      var YDatasetsRepeater = settings.wadiYDatasetsRepeater;
      var YDatasets = []; // Data Object will contain Datasets and Label to be added to Chart Config

      var data = {};

      if ('custom' === settings.wadiChartContentType) {
        YDatasetsRepeater.map(function (item, index) {
          var _settings$wadiPieDoug, _settings$wadiPieDoug2, _settings$wadiPieDoug3, _settings$wadiPieDoug4, _settings$wadiPieDoug5, _settings$wadiPieDoug6, _settings$wadiPieDoug7, _settings$wadiPieDoug8, _settings$wadiPieDoug9, _settings$wadiPieDoug10, _settings$wadiLineTen, _settings$wadiLineTen2;

          var theLabel = item.wadi_chart_y_axis_label;
          var YAxisBGColors = [];

          if ('' !== item.wadi_chart_y_axis_background_colors) {
            item.wadi_chart_y_axis_background_colors.split(',').map(function (color, index) {
          ...
          var YAxisBorderColors = [];

          if ('' !== item.wadi_chart_y_axis_border_colors) {
            item.wadi_chart_y_axis_border_colors.split(',').map(function (color, index) {
          ...
          var YAxisHoverBGColors = [];

          if ('' !== item.wadi_chart_y_axis_hover_background_colors) {
            item.wadi_chart_y_axis_hover_background_colors.split(',').map(function (color, index) {
          ...
          if ('' !== item.wadi_chart_y_axis_data) {
            item.wadi_chart_y_axis_data.split(',').map(function (dataItem, index) {
              // console.log("dataItemaaa::",dataItem, typeof(dataItem))
              YData.push(dataItem.trim());
            });
          }

          _this2.wadiDatasetURLs = [];

          if ('' !== item.wadi_chart_y_axis_urls) {
            item.wadi_chart_y_axis_urls.split(',').map(function (datasetUrl, index) {
              _this2.wadiDatasetURLs.push(datasetUrl.trim());
            });
          }

          YDatasets.push(_objectSpread(_objectSpread(_objectSpread(_objectSpread({
            label: theLabel,
            ...
            barPercentage: 0.5
          }), settings.wadiAdvancedPieDoughnutSettings && _objectSpread(_objectSpread(_objectSpread(_objectSpread(_objectSpread({}, !!((_settings$wadiPieDoug = settings.wadiPieDoughnutHoverOffset) !== null && _settings$wadiPieDoug !== void 0 && _settings$wadiPieDoug.size) && {
            hoverOffset: (_settings$wadiPieDoug2 = settings.wadiPieDoughnutHoverOffset) === null || _settings$wadiPieDoug2 === void 0 ? void 0 : _settings$wadiPieDoug2.size
          }), !!((_settings$wadiPieDoug3 = settings.wadiPieDoughnutOffset) !== null && _settings$wadiPieDoug3 !== void 0 && _settings$wadiPieDoug3.size) && {
            offset: (_settings$wadiPieDoug4 = settings.wadiPieDoughnutOffset) === null || _settings$wadiPieDoug4 === void 0 ? void 0 : _settings$wadiPieDoug4.size
          }), !!((_settings$wadiPieDoug5 = settings.wadiPieDoughnutSpacing) !== null && _settings$wadiPieDoug5 !== void 0 && _settings$wadiPieDoug5.size) && {
            spacing: (_settings$wadiPieDoug6 = settings.wadiPieDoughnutSpacing) === null || _settings$wadiPieDoug6 === void 0 ? void 0 : _settings$wadiPieDoug6.size
          }), !!((_settings$wadiPieDoug7 = settings.wadiPieDoughnutCircumference) !== null && _settings$wadiPieDoug7 !== void 0 && _settings$wadiPieDoug7.size) && {
            circumference: (_settings$wadiPieDoug8 = settings.wadiPieDoughnutCircumference) === null || _settings$wadiPieDoug8 === void 0 ? void 0 : _settings$wadiPieDoug8.size
          }), !!((_settings$wadiPieDoug9 = settings.wadiPieDoughnutRotation) !== null && _settings$wadiPieDoug9 !== void 0 && _settings$wadiPieDoug9.size) && {
            rotation: (_settings$wadiPieDoug10 = settings.wadiPieDoughnutRotation) === null || _settings$wadiPieDoug10 === void 0 ? void 0 : _settings$wadiPieDoug10.size
          })), settings.wadiAdvancedLineSettings && _objectSpread(_objectSpread(_objectSpread({}, !!((_settings$wadiLineTen = settings.wadiLineTension) !== null && _settings$wadiLineTen !== void 0 && _settings$wadiLineTen.size) && {
            tension: (_settings$wadiLineTen2 = settings.wadiLineTension) === null || _settings$wadiLineTen2 === void 0 ? void 0 : _settings$wadiLineTen2.size
          }), !!settings.wadiLineStepped && {
            stepped: settings.wadiLineStepped
          }), !!settings.wadiLineHorizontal && {
      ...
      var legendClickHandler = function legendClickHandler(e, legendItem, legend) {
      ...
      var chartOptions = _objectSpread(_objectSpread({}, settings.wadiBarHorizontalSwitcher && {
        indexAxis: 'y'
      }), {}, {
        animation: {
          duration: (_settings$wadiAnimati = settings.wadiAnimationDuration) === null || _settings$wadiAnimati === void 0 ? void 0 : _settings$wadiAnimati.size,
          easing: settings.wadiAnimationType,
          delay: (_settings$wadiAnimati2 = settings.wadiAnimationDelay) === null || _settings$wadiAnimati2 === void 0 ? void 0 : _settings$wadiAnimati2.size
        },
        elements: {
          point: _objectSpread(_objectSpread(_objectSpread(_objectSpread(_objectSpread(_objectSpread({}, !!settings.wadiPointType && {
            pointStyle: settings.wadiPointType
          }), !!settings.wadiPointRadius && {
            radius: (_settings$wadiPointRa = settings.wadiPointRadius) === null || _settings$wadiPointRa === void 0 ? void 0 : _settings$wadiPointRa.size
          }), !!settings.wadiPointHoverRadius && {
            hoverRadius: (_settings$wadiPointHo = settings.wadiPointHoverRadius) === null || _settings$wadiPointHo === void 0 ? void 0 : _settings$wadiPointHo.size
          }), !!settings.wadiPointBorderWidth && {
            borderWidth: (_settings$wadiPointBo = settings.wadiPointBorderWidth) === null || _settings$wadiPointBo === void 0 ? void 0 : _settings$wadiPointBo.size
          }), !!settings.wadiPointHoverBorderWidth && {
            hoverBorderWidth: (_settings$wadiPointHo2 = settings.wadiPointHoverBorderWidth) === null || _settings$wadiPointHo2 === void 0 ? void 0 : _settings$wadiPointHo2.size
          }), !!settings.wadiPointHitRadius && {
            hitRadius: (_settings$wadiPointHi = settings.wadiPointHitRadius) === null || _settings$wadiPointHi === void 0 ? void 0 : _settings$wadiPointHi.size
          }),
          line: _objectSpread(_objectSpread({}, !!settings.wadiChartFillLine && {
        ...
        layout: {
          padding: (_settings$wadiChartLa = settings.wadiChartLayoutPadding) === null || _settings$wadiChartLa === void 0 ? void 0 : _settings$wadiChartLa.size
        },
        scales: {
          x: {
            display: settings.wadiChartXDisplay,
            grid: {
              display: settings.wadiChartXGridLines // tickLength: 20,
              // tickColor: '#F05A28',
              // borderWidth: 12,
              // lineWidth: 9,
              // offset: true
          ...
          y: {
            ...
            grid: {
              display: settings.wadiChartYGridLines // tickLength: 20,
              // tickColor: '#F05A28',
              // lineWidth: 9,
              // color: '#F05A28',
        ...
        plugins: {
          legend: _objectSpread(_objectSpread({
          ...
          }, !!settings.wadiChartLegendDisplay && _objectSpread(_objectSpread(_objectSpread({}, !!settings.wadiChartLegendPosition && {
          ...
          }, !!settings.wadiChartLegendRTL && _objectSpread({}, !!settings.wadiChartLegendRTLTextDirection && {
            ...
            labels: {
              ...
              font: {
                size: (_settings$wadiChartLe = settings.wadiChartLegendLabelsFontSize) === null || _settings$wadiChartLe === void 0 ? void 0 : _settings$wadiChartLe.size,
                weight: settings.wadiChartLegendLabelsFontWeight
              },
              padding: (_settings$wadiChartLe2 = settings.wadiChartLegendLabelsPadding) === null || _settings$wadiChartLe2 === void 0 ? void 0 : _settings$wadiChartLe2.size,
              // pointStyle: 'circle',
              // usePointStyle: true,
              textAlign: 'right'
            },
            ...
            }, !!settings.wadiChartLengendTitle && _objectSpread(_objectSpread({}, !!settings.wadiChartLegenedTitleText && {
              text: settings.wadiChartLegenedTitleText
            }), {}, {
              color: settings.wadiChartLegendTitleColor,
              font: {
                size: (_settings$wadiChartLe3 = settings.wadiChartLegendTitleFontSize) === null || _settings$wadiChartLe3 === void 0 ? void 0 : _settings$wadiChartLe3.size,
                weight: settings.wadiChartLegendTitleFontWeight
              },
              padding: {
                top: (_settings$wadiChartLe4 = settings.wadiChartLegendTitlePadding) === null || _settings$wadiChartLe4 === void 0 ? void 0 : _settings$wadiChartLe4.size,
                bottom: (_settings$wadiChartLe5 = settings.wadiChartLegendTitlePadding) === null || _settings$wadiChartLe5 === void 0 ? void 0 : _settings$wadiChartLe5.size
              }
            })),
          ...
          title: _objectSpread({
          ...
          }, !!settings.wadiChartTitleSwitcher && _objectSpread(_objectSpread(_objectSpread(_objectSpread({}, !!settings.wadiChartTitleText && {
            ...
            font: {
              size: (_settings$wadiChartTi = settings.wadiChartTitleFontSize) === null || _settings$wadiChartTi === void 0 ? void 0 : _settings$wadiChartTi.size,
              weight: settings.wadiChartTitleFontWeight
            },
            padding: (_settings$wadiChartTi2 = settings.wadiChartTitlePadding) === null || _settings$wadiChartTi2 === void 0 ? void 0 : _settings$wadiChartTi2.size
          })),
          tooltip: _objectSpread({
            ...
            cornerRadius: (_settings$wadiChartTo = settings.wadiChartTooltipCornerRadius) === null || _settings$wadiChartTo === void 0 ? void 0 : _settings$wadiChartTo.size,
            padding: (_settings$wadiChartTo2 = settings.wadiChartTooltipPadding) === null || _settings$wadiChartTo2 === void 0 ? void 0 : _settings$wadiChartTo2.size,
            // Tooltips Title
            titleColor: settings.wadiChartTooltipTitleColor,
            titleFont: {
              size: (_settings$wadiChartTo3 = settings.wadiChartTooltipTitleFontSize) === null || _settings$wadiChartTo3 === void 0 ? void 0 : _settings$wadiChartTo3.size,
              weight: settings.wadiChartTooltipTitleFontWeight
            },
            titleAlign: settings.wadiChartTooltipTitleAlignment,
            titleSpacing: (_settings$wadiChartTo4 = settings.wadiChartTooltipTitleSpacing) === null || _settings$wadiChartTo4 === void 0 ? void 0 : _settings$wadiChartTo4.size,
            titleMarginBottom: (_settings$wadiChartTo5 = settings.wadiChartTooltipTitleMarginBottom) === null || _settings$wadiChartTo5 === void 0 ? void 0 : _settings$wadiChartTo5.size,
            // Tooltip Body
            bodyColor: settings.wadiChartTooltipBodyColor,
            bodyFont: {
              size: (_settings$wadiChartTo6 = settings.wadiChartTooltipBodyFontSize) === null || _settings$wadiChartTo6 === void 0 ? void 0 : _settings$wadiChartTo6.size,
              weight: settings.wadiChartTooltipBodyFontWeight
            },
            bodyAlign: settings.wadiChartTooltipBodyAlignment,
            bodySpacing: (_settings$wadiChartTo7 = settings.wadiChartTooltipBodySpacing) === null || _settings$wadiChartTo7 === void 0 ? void 0 : _settings$wadiChartTo7.size,
            // Tooltip Caret
            caretPadding: (_settings$wadiChartTo8 = settings.wadiChartTooltipCaretPadding) === null || _settings$wadiChartTo8 === void 0 ? void 0 : _settings$wadiChartTo8.size,
            caretSize: (_settings$wadiChartTo9 = settings.wadiChartTooltipCaretSize) === null || _settings$wadiChartTo9 === void 0 ? void 0 : _settings$wadiChartTo9.size
          }, 'polarArea' === settings.wadiChartType && {
            callbacks: {
              label: function label(context) {
                var tooltipText = '';
                var label = context.dataset.label || '';
                var polarAreaLabelValue = context.label || '';
      ...
      options = _objectSpread({}, chartOptions); // console.log('Chart options',options);
      ...
      if ('custom' === settings.wadiChartContentType) {
        ...
        if (settings.wadiChartDisplayEvent === true) {
          var waypoint = new Waypoint({
            ...
            handler: function handler() {
              var wadiCustomChart = new chart_js_auto__WEBPACK_IMPORTED_MODULE_0__["default"](settings.wadiChartCanvasElement, config);
        ...
        var chartsSettings = this.getElementSettings();
        var wadiLoader = document.createElement("div");
        wadiLoader.classList.add('wadi_loader');
        settings.wadiChartContainer.appendChild(wadiLoader);
        var wadiChartURL = chartsSettings.wadi_chart_url_type === 'remote' ? chartsSettings.wadi_chart_csv_remote_link : chartsSettings.wadi_chart_csv_file.url;
        ...
        if (wadiChartURL) {
          jQuery.ajax({
            ...
            success: function success(res) {
              ...
              var ctx = settings.wadiChartCanvasElement;
              var rowsData = res.split(/\r?\n|\r/);
              var labels = rowsData.shift().split(settings.wadiChartCSVSeparator);
              var CSVRepeaterData = settings.wadiChartCSVYRepeater;
              var wadiChartCSVYTitle, wadiChartCSVYColor, wadiChartCSVYBorderColor, wadiChartCSVYBorderWidth;
              var csvDatasets = [];
              rowsData.map(function (item, index) {
                var _settings$wadiPieDoug11, _settings$wadiPieDoug12, _settings$wadiPieDoug13, _settings$wadiPieDoug14, _settings$wadiPieDoug15, _settings$wadiPieDoug16, _settings$wadiPieDoug17, _settings$wadiPieDoug18, _settings$wadiPieDoug19, _settings$wadiPieDoug20, _settings$wadiLineTen3, _settings$wadiLineTen4;
                ...
                _this3.wadiCSVDatasetURLs = [];

                if (CSVRepeaterData[index]) {
                  if (CSVRepeaterData[index].wadi_chart_csv_y_axis_urls) {
                    CSVRepeaterData[index].wadi_chart_csv_y_axis_urls.split(',').map(function (dataSetCSVURL, index) {
                      _this3.wadiCSVDatasetURLs.push(dataSetCSVURL.trim());
                    });
                  }
                }

                csvDatasets.push(_objectSpread(_objectSpread(_objectSpread(_objectSpread({
                  ...
                  hoverBorderColor: settings.wadiYAxisHoverBorderColor,
                  links: _this3.wadiCSVDatasetURLs
                }, settings.wadiAdvancedBarSettings && {
                  borderRadius: settings.wadiBarBorderRadius,
                  hoverBorderRadius: settings.wadiHoverBarBorderRadius,
                  barThickness: settings.wadiBarThickness,
                  barPercentage: 0.5
                }), settings.wadiAdvancedPieDoughnutSettings && _objectSpread(_objectSpread(_objectSpread(_objectSpread(_objectSpread({}, !!((_settings$wadiPieDoug11 = settings.wadiPieDoughnutHoverOffset) !== null && _settings$wadiPieDoug11 !== void 0 && _settings$wadiPieDoug11.size) && {
                  hoverOffset: (_settings$wadiPieDoug12 = settings.wadiPieDoughnutHoverOffset) === null || _settings$wadiPieDoug12 === void 0 ? void 0 : _settings$wadiPieDoug12.size
                }), !!((_settings$wadiPieDoug13 = settings.wadiPieDoughnutOffset) !== null && _settings$wadiPieDoug13 !== void 0 && _settings$wadiPieDoug13.size) && {
                  offset: (_settings$wadiPieDoug14 = settings.wadiPieDoughnutOffset) === null || _settings$wadiPieDoug14 === void 0 ? void 0 : _settings$wadiPieDoug14.size
                }), !!((_settings$wadiPieDoug15 = settings.wadiPieDoughnutSpacing) !== null && _settings$wadiPieDoug15 !== void 0 && _settings$wadiPieDoug15.size) && {
                  spacing: (_settings$wadiPieDoug16 = settings.wadiPieDoughnutSpacing) === null || _settings$wadiPieDoug16 === void 0 ? void 0 : _settings$wadiPieDoug16.size
                }), !!((_settings$wadiPieDoug17 = settings.wadiPieDoughnutCircumference) !== null && _settings$wadiPieDoug17 !== void 0 && _settings$wadiPieDoug17.size) && {
                  circumference: (_settings$wadiPieDoug18 = settings.wadiPieDoughnutCircumference) === null || _settings$wadiPieDoug18 === void 0 ? void 0 : _settings$wadiPieDoug18.size
                }), !!((_settings$wadiPieDoug19 = settings.wadiPieDoughnutRotation) !== null && _settings$wadiPieDoug19 !== void 0 && _settings$wadiPieDoug19.size) && {
                  rotation: (_settings$wadiPieDoug20 = settings.wadiPieDoughnutRotation) === null || _settings$wadiPieDoug20 === void 0 ? void 0 : _settings$wadiPieDoug20.size
                })), settings.wadiAdvancedLineSettings && _objectSpread(_objectSpread(_objectSpread({}, !!((_settings$wadiLineTen3 = settings.wadiLineTension) !== null && _settings$wadiLineTen3 !== void 0 && _settings$wadiLineTen3.size) && {
                  tension: (_settings$wadiLineTen4 = settings.wadiLineTension) === null || _settings$wadiLineTen4 === void 0 ? void 0 : _settings$wadiLineTen4.size
                }), !!settings.wadiLineStepped && {
                  stepped: settings.wadiLineStepped
                }), !!settings.wadiLineHorizontal && {
                  // Horizontal Chart Line
              ...
              if (settings.wadiChartDisplayEvent === true) {
                var _waypoint = new Waypoint({
                  ...
                  triggerOnce: true,
                  handler: function handler() {
                    chartInstance = new chart_js_auto__WEBPACK_IMPORTED_MODULE_0__["default"](ctx, {
                      type: settings.wadiChartType,
                      data: data,
                      options: _objectSpread({}, chartOptions)
                    }); // CSV Rows Data
                    ...
                    rowsData.forEach(function (row, index) {
                      if (row.length !== 0 && csvDatasets.length > 0) {
                        ...
                        rowData = row.split(settings.wadiChartCSVSeparator); // Check if the dataset exists
                      ...
                      _this3.wadiChartLinks(settings.wadiChartCanvasElement, chartInstance);
    ...
    key: "wadiChartLinks",
    value: function wadiChartLinks(elementChart, chartObject) {
      elementChart.addEventListener('click', function (evt) {
        var activePoint = chartObject.getElementsAtEventForMode(evt, 'point', chartObject.options);
...
jQuery(window).on("elementor/frontend/init", function () {
  ...
  elementorFrontend.hooks.addAction("frontend/element_ready/wadi-charts-addon.default", addHandler);
});
}();
/******/ })()
;
//# sourceMappingURL=wadi-charts.js.map