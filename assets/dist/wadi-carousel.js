...
/* harmony import */ var _style_carousel_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./style/carousel.scss */ "./src/style/carousel.scss");
...
var WadiCarousel = /*#__PURE__*/function (_elementorModules$fro) {
  _inherits(WadiCarousel, _elementorModules$fro);

  var _super = _createSuper(WadiCarousel);

  function WadiCarousel() {
    _classCallCheck(this, WadiCarousel);

    return _super.apply(this, arguments);
  }

  _createClass(WadiCarousel, [{
    ...
    value: function initiate() {
      ...
      var $wadiSwiperElem = this.elements.wadiSwiperElem;
      var elementsSettings = this.getElementSettings();
      var currentDeviceMode = elementorFrontend.getCurrentDeviceMode();
      var selectors = this.getSettings('selectors');

      var wadiSwiperSettings = _objectSpread(_objectSpread(_objectSpread(_objectSpread(_objectSpread({
    ...
    key: "wadiSwiper",
    value: function wadiSwiper(wadiSwiperElem, settings) {
      var _breakpoints;

      var carouselBreakpointMobile = settings.carouselBreakPoints.mobile;
      var carouselBreakpointTablet = settings.carouselBreakPoints.tablet;
      var carouselBreakpointDesktop = settings.carouselBreakPoints.desktop; // console.log("THE SETTINGS:", settings);

      var $this = this;
      var wadiSwiperElement = settings.wadiSwiperElement; // const elementSwiper = document.querySelector(`${wadiSwiperElement}`);
      // console.log(elementSwiper);

      new _node_modules_swiper__WEBPACK_IMPORTED_MODULE_0__["default"](wadiSwiperElement, _objectSpread(_objectSpread(_objectSpread(_objectSpread(_objectSpread(_objectSpread(_objectSpread(_objectSpread({
        modules: [_node_modules_swiper__WEBPACK_IMPORTED_MODULE_0__.EffectFade, _node_modules_swiper__WEBPACK_IMPORTED_MODULE_0__.EffectCube, _node_modules_swiper__WEBPACK_IMPORTED_MODULE_0__.EffectFlip, _node_modules_swiper__WEBPACK_IMPORTED_MODULE_0__.EffectCoverflow, _node_modules_swiper__WEBPACK_IMPORTED_MODULE_0__.EffectCards, _node_modules_swiper__WEBPACK_IMPORTED_MODULE_0__.FreeMode, _node_modules_swiper__WEBPACK_IMPORTED_MODULE_0__.Autoplay, _node_modules_swiper__WEBPACK_IMPORTED_MODULE_0__.Controller, _node_modules_swiper__WEBPACK_IMPORTED_MODULE_0__.Mousewheel, _node_modules_swiper__WEBPACK_IMPORTED_MODULE_0__.Navigation, _node_modules_swiper__WEBPACK_IMPORTED_MODULE_0__.Pagination, _node_modules_swiper__WEBPACK_IMPORTED_MODULE_0__.Scrollbar],
        // Optional parameters
        ...
        }, settings.carouselDirection === 'vertical' && settings.carouselPaginationType === 'progressbar' && {
          progressbarOpposite: settings.carouselProgressbarOpposite
        })
...
jQuery(window).on("elementor/frontend/init", function () {
  ...
  elementorFrontend.hooks.addAction("frontend/element_ready/wadi-carousel-addon.default", addHandler);
});
}();
/******/ })()
;
//# sourceMappingURL=wadi-carousel.js.map