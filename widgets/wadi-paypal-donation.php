...
class Wadi_Paypal_Donation extends Widget_Base
{
    public function get_name()
    {
        return 'wadi-paypal-donation-addon';
    }
    
    public function get_title()
    {
        return sprintf( '%1$s %2$s', 'Wadi', __( 'PayPal Donation', 'wadi-addons' ) );
    }
    
    public function get_icon()
    {
        return 'wadi-paypal-donation';
    }
