...
class Wadi_Image_Comparison extends Widget_Base
{
    public function get_name()
    {
        return 'wadi-image-comparison-addon';
    }
    
    public function get_title()
    {
        return sprintf( '%1$s %2$s', 'Wadi', __( 'Image Comparison', 'wadi-addons' ) );
    }
    
    public function get_icon()
    {
        return 'wadi-image-comparison-2';
    }
